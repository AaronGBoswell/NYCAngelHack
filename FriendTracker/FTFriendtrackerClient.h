 ...
 */
@interface FTFriendtrackerClient: AWSAPIGatewayClient
 ...
 *Swift*
     ...
     let serviceClient = FTFriendtrackerClient.defaultClient()

 *Objective-C*

     FTFriendtrackerClient *serviceClient = [FTFriendtrackerClient defaultClient];
 ...
 *Swift*
     ...
     func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
         ...
         FTFriendtrackerClient.registerClientWithConfiguration(configuration, forKey: "USWest2FTFriendtrackerClient")
 ...
 *Swift*
     ...
     let serviceClient = FTFriendtrackerClient(forKey: "USWest2FTFriendtrackerClient")

 *Objective-C*

     FTFriendtrackerClient *serviceClient = [FTFriendtrackerClient clientForKey:@"USWest2FTFriendtrackerClient"];
...
/**
 ...
 return type: 
 */
- (AWSTask *)updateLocationPut:(FTUpdateLocationModel *)body;
...
/**
 ...
 return type: 
 */
- (AWSTask *)updateStatePut:(FTUserUpdateModel *)body;
