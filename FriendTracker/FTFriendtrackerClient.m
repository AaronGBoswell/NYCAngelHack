...
@interface FTFriendtrackerClient()
...
@implementation FTFriendtrackerClient
...
+ (instancetype)defaultClient {
    ...
    static FTFriendtrackerClient *_defaultClient = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _defaultClient = [[FTFriendtrackerClient alloc] initWithConfiguration:serviceConfiguration];
    });
...
+ (void)registerClientWithConfiguration:(AWSServiceConfiguration *)configuration forKey:(NSString *)key {
    ...
    [_serviceClients setObject:[[FTFriendtrackerClient alloc] initWithConfiguration:configuration]
                        forKey:key];
}
...
- (instancetype)initWithConfiguration:(AWSServiceConfiguration *)configuration {
    if (self = [super init]) {
        ...
        NSString *URLString = @"https://y08gwrxeo0.execute-api.us-west-2.amazonaws.com/prod";
